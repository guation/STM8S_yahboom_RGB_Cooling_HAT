...
void Ws2812b_Write(unsigned long color);
 
void RGB_Refresh(unsigned long color,unsigned char num);
void RGB_Cycle(unsigned long color,unsigned char num,unsigned short speed);
void RGB_Wave(unsigned long color,unsigned char num,unsigned short speed);
void RGB_Flash(unsigned long color,unsigned char num,unsigned short speed,unsigned char cnt);
